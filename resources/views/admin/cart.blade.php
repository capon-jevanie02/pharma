...
<script type="text/javascript">
    ...
    $(".checkout-button").click(function (e) {
        ...
        // Show a confirmation prompt with the total price
        if (confirm("The total price is P" + totalPrice + ". Do you want to proceed to checkout?")) {
            $.ajax({
                url: '{{ route('checkout') }}',
                method: "POST",
                data: {
                ...
                success: function (response) {
                    if (response.success) {
                        alert("Checkout successful! Total price: P" + totalPrice);
                        
                        // Clear the cart UI and show a message
                        $("#cart tbody").empty();
                        $("#cart tfoot").html(`
                            <tr>
                                <td colspan="5" class="text-center">
